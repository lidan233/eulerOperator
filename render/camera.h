...
typedef void (*framebuffer_size_callbackFunc)(GLFWwindow* , int , int ) ;
typedef void (*mouse_callbackFunc)(GLFWwindow* , double , double ) ;
typedef void (*scroll_callbackFunc)(GLFWwindow* , double , double ) ;
...
public:
    ...
    Camera(glm::vec3 front=glm::vec3(0.0f, 0.0f, -1.0f),
